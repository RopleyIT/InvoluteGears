...
namespace GearTests
{
    ...
    {
        [DataTestMethod]
        [DataRow(8, 12, 6.0, 0.1, 6.35)]
        [DataRow(96, 12, 6.0, 0.1, 6.35)]
        [DataRow(12, 96, 6.0, 0.1, 6.35)]
        [DataRow(12, 10, 6.0, 0.1, 6.35)]
        [DataRow(14, 10, 6.0, 0.1, 6.35)]
        ...
        [DataTestMethod]
        [DataRow(96, 12, 50, 50, 5.0, 0.1, 6.35)]
        [DataRow(12, 96, 50, 50, 5.0, 0.1, 6.35)]
        [DataRow(12, 10, 50, 50, 5.0, 0.1, 6.35)]
        [DataRow(10, 12, 50, 50, 5.0, 0.1, 6.35)]
